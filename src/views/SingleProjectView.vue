        ...
        <div class="container">
            ...
            <div class="card border-0 mx-auto col-3 d-flex flex-column gap-4">
                ...
                <div class="links d-flex flex-column gap-2 py-4">
                    <a class="btn d-flex align-items-center justify-content-center gap-2" :href="project.git_url"
                        target="_blank">
                    ...
                    <a class="btn d-flex align-items-center justify-content-center gap-2" :href="project.project_url"
                        target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
